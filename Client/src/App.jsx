    ...
    <>
      <Router>
        <Routes>
          ...
          <Route exact path="/otherStations/payments" element={<Payments />} />
          <Route exact path="/otherStations" element={<Other />} />
          <Route exact path="/checkAvail" element={<Check />} />
          <Route exact path="/renew/payments" element={<Payments />} />
          <Route exact path="/renew" element={<Renew />} />
          <Route exact path="/rechargeSmart/payments" element={<Payments />} />
          <Route exact path="/rechargeSmart" element={<RechargeSmart />} />
          <Route exact path="/printTicket" element={<PrintTicket />} />
          <Route exact path="/platTicket/payments" element={<Payments />} />
          <Route exact path="/platTicket" element={<PlatTicket />} />
          <Route exact path="/sCardDetails/payments" element={<Payments />} />
